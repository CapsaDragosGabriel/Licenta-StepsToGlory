...
[CreateAssetMenu]
public class BulletRain : Ability
{
    ...
    public override void Activate(GameObject parent)
    {
        ...
        float totalDamage = baseDamage + ap * 0.3f;
        Vector3 mousePos = Camera.main.ScreenToWorldPoint(Input.mousePosition);
        mousePos.z = 0;
        spriteInstance = Instantiate(sprite);

        spriteInstance.GetComponent<BulletRainPeriodic>().SetDamage(totalDamage);
        spriteInstance.GetComponent<BulletRainPeriodic>().SetTickRate(tickRate);
