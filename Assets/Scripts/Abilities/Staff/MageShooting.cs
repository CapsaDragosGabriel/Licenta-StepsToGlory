...
public class MageShooting : MonoBehaviour
{
    ...
    void Shoot()
    {
        ...
        bullet.GetComponent<MageProjectile>().damage += (Mathf.Pow(playerStats.GetStatValue(StatType.ad), 2)+ Mathf.Pow(playerStats.GetStatValue(StatType.ap), 2)) / Mathf.Pow(3, 2);
