...
public class ShotgunAI : MonoBehaviour, IEffecteable
{
    ...
    void Shoot()
    {
        ...
        { 
            ...
            if (target != null)
            {
                ...
                Vector2 shootDirection = (Vector2)target.position - (Vector2)firePoint.position + new Vector2(Random.Range(minSpread, maxSpread), Random.Range(minSpread, maxSpread)) ;
